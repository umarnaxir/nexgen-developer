          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-12">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">1. Acceptance of Terms</h2>
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">2. Use License</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
                  ...
                  <ul className="list-disc pl-5 sm:pl-6 space-y-1.5 sm:space-y-2 text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">3. Services</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
                  ...
                  <div className="bg-gray-900 p-4 sm:p-5 lg:p-6 rounded-lg border border-gray-700 mb-4 sm:mb-6">
                    ...
                    <ol className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-200">
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="bg-white text-black rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0 mt-0.5">1</span>
                      ...
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="bg-white text-black rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0 mt-0.5">2</span>
                      ...
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="bg-white text-black rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0 mt-0.5">3</span>
                      ...
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="bg-white text-black rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0 mt-0.5">4</span>
                      ...
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="bg-white text-black rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0 mt-0.5">5</span>
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">5. Intellectual Property</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">6. User Accounts and Registration</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">7. Content Guidelines and Prohibited Uses</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">8. Limitation of Liability</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">9. Indemnification</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">10. Termination</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">11. Changes to Terms</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-3 sm:mb-4">12. Contact Information</h2>
                  <p className="text-sm sm:text-base text-gray-200 leading-relaxed mb-4 sm:mb-6">
