  ...
  return (
    <div className="mb-10 sm:mb-12 md:mb-16">
      ...
      >
        ...
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold text-black mb-3 sm:mb-4">Our Mission</h2>
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4">
        ...
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold text-black mb-3 sm:mb-4">What We Do</h2>
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4">
        ...
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold text-black mb-3 sm:mb-4">Our Approach</h2>
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4">
