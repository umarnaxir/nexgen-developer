        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-12">
            ...
            <motion.section
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-gray-50 p-4 sm:p-6 lg:p-8 rounded-xl border-2 border-gray-200 transition-all duration-300"
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                <div className="bg-black p-2 sm:p-3 rounded-lg flex-shrink-0">
                  <Shield className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">1. Introduction</h2>
            ...
            <motion.section
              ...
              className="bg-white p-4 sm:p-6 lg:p-8 rounded-xl border-2 border-gray-200 transition-all duration-300"
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                <div className="bg-black p-2 sm:p-3 rounded-lg flex-shrink-0">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">2. Information We Collect</h2>
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">3. How We Use Your Information</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4 sm:mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                    <div className="bg-white p-4 sm:p-5 rounded-lg border border-gray-200">
                      <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-black mb-2 sm:mb-3" />
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2">Service Delivery</h3>
                    ...
                    <div className="bg-white p-4 sm:p-5 rounded-lg border border-gray-200">
                      <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-black mb-2 sm:mb-3" />
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2">Communication</h3>
                      <ul className="text-xs sm:text-sm text-gray-700 space-y-1">
                    ...
                    <div className="bg-white p-4 sm:p-5 rounded-lg border border-gray-200">
                      <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6 text-black mb-2 sm:mb-3" />
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2">Analytics & Improvement</h3>
                      <ul className="text-xs sm:text-sm text-gray-700 space-y-1">
                    ...
                    <div className="bg-white p-4 sm:p-5 rounded-lg border border-gray-200">
                      <FileText className="w-5 h-5 sm:w-6 sm:h-6 text-black mb-2 sm:mb-3" />
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2">Content Management</h3>
                      <ul className="text-xs sm:text-sm text-gray-700 space-y-1">
                  ...
                  <div className="bg-yellow-500/20 border border-yellow-500/50 p-3 sm:p-4 rounded-lg">
                    <div className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div>
                        <p className="text-xs sm:text-sm text-yellow-800 font-semibold mb-1">Legal Basis for Processing</p>
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">4. Information Sharing and Disclosure</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
                  ...
                  <div className="space-y-3 sm:space-y-4 mb-3 sm:mb-4">
                    <div className="bg-gray-50 p-4 sm:p-5 rounded-lg border border-gray-200">
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2">Service Providers</h3>
                      <p className="text-xs sm:text-sm text-gray-700">
                    ...
                    <div className="bg-gray-50 p-4 sm:p-5 rounded-lg border border-gray-200">
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2">Business Transfers</h3>
                      <p className="text-xs sm:text-sm text-gray-700">
                    ...
                    <div className="bg-gray-50 p-4 sm:p-5 rounded-lg border border-gray-200">
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2">Legal Requirements</h3>
                      <p className="text-xs sm:text-sm text-gray-700">
                        We may disclose your information if required to do so by law or in response to valid requests by public authorities (e.g., a court or government agency).
                      </p>
                    </div>
                    <div className="bg-gray-50 p-4 sm:p-5 rounded-lg border border-gray-200">
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2">Published Content (Write for Us)</h3>
                      <p className="text-xs sm:text-sm text-gray-700">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">5. Data Security</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4 sm:mb-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
                    <div className="bg-white p-4 sm:p-5 rounded-lg border border-gray-200">
                      <Lock className="w-5 h-5 sm:w-6 sm:h-6 text-black mb-2 sm:mb-3" />
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2">Encryption</h3>
                      <p className="text-xs sm:text-sm text-gray-700">
                        We use SSL/TLS encryption to protect data in transit and encryption at rest for sensitive information.
                      </p>
                    </div>
                    <div className="bg-white p-4 sm:p-5 rounded-lg border border-gray-200">
                      <Shield className="w-5 h-5 sm:w-6 sm:h-6 text-black mb-2 sm:mb-3" />
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2">Access Controls</h3>
                      <p className="text-xs sm:text-sm text-gray-700">
                        Limited access to personal information on a need-to-know basis with strong authentication requirements.
                      </p>
                    </div>
                    <div className="bg-white p-4 sm:p-5 rounded-lg border border-gray-200">
                      <Database className="w-5 h-5 sm:w-6 sm:h-6 text-black mb-2 sm:mb-3" />
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2">Secure Storage</h3>
                      <p className="text-xs sm:text-sm text-gray-700">
                  ...
                  <div className="bg-yellow-500/20 border border-yellow-500/50 p-3 sm:p-4 rounded-lg">
                    <div className="flex items-start gap-2 sm:gap-3">
                      <AlertCircle className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-600 flex-shrink-0 mt-0.5" />
                      <div>
                        <p className="text-xs sm:text-sm text-yellow-800 font-semibold mb-1">Important Security Note</p>
                        <p className="text-xs sm:text-sm text-yellow-700">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">6. Your Privacy Rights</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4 sm:mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                    <div className="bg-gray-50 p-4 sm:p-5 rounded-lg border border-gray-200">
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2 sm:mb-3">Access & Portability</h3>
                      <ul className="text-xs sm:text-sm text-gray-700 space-y-1.5 sm:space-y-2">
                    ...
                    <div className="bg-gray-50 p-4 sm:p-5 rounded-lg border border-gray-200">
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2 sm:mb-3">Correction & Deletion</h3>
                      <ul className="text-xs sm:text-sm text-gray-700 space-y-1.5 sm:space-y-2">
                    ...
                    <div className="bg-gray-50 p-4 sm:p-5 rounded-lg border border-gray-200">
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2 sm:mb-3">Consent & Objection</h3>
                      <ul className="text-xs sm:text-sm text-gray-700 space-y-1.5 sm:space-y-2">
                    ...
                    <div className="bg-gray-50 p-4 sm:p-5 rounded-lg border border-gray-200">
                      <h3 className="font-bold text-sm sm:text-base text-black mb-2 sm:mb-3">Restriction & Complaint</h3>
                      <ul className="text-xs sm:text-sm text-gray-700 space-y-1.5 sm:space-y-2">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">7. Data Retention</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
                    We will retain your personal information only for as long as necessary to fulfill the purposes outlined in this Privacy Policy, unless a longer retention period is required or permitted by law.
                  </p>
                  <div className="bg-white p-4 sm:p-5 rounded-lg border border-gray-200 mb-3 sm:mb-4">
                    <h3 className="font-bold text-sm sm:text-base text-black mb-2 sm:mb-3">Retention Periods:</h3>
                    <ul className="text-xs sm:text-sm text-gray-700 space-y-1.5 sm:space-y-2">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">8. International Data Transfers</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">9. Children's Privacy</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-3 sm:mb-4">10. Changes to This Privacy Policy</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-3 sm:mb-4">11. Contact Us</h2>
                  ...
                  <p className="text-xs sm:text-sm text-gray-200 mt-4 sm:mt-6">
